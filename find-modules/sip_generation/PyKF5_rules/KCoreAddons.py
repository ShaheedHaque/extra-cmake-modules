...
def parameter_rules():
    return [
        ["KShell", "splitArgs", "flags", ".*", ".*", rules_engine.parameter_qualify_enum_initialiser],
        ["KUrlMimeData", "urlsFromMimeData", "decodeOptions", ".*", ".*", rules_engine.parameter_qualify_enum_initialiser],
    ]
